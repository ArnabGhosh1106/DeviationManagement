...
import { DEVIATION_AGENTS } from "@/lib/ai-agents";
    ...
    <div className="space-y-8 pb-10">
        ...
        <div className="mt-4 flex flex-wrap items-start justify-between gap-4 border-b border-border pb-6">
          <div>
            <div className="flex items-center gap-2">
              <span className="grid size-8 place-items-center rounded-lg bg-info-soft text-primary">
          ...
          <div className="flex flex-col items-end gap-2">
            <StatusBadge
              status={allDone ? "Completed" : "Under Investigation"}
            />
      ...
      {allDone ? (
        <>
          ...
          <div id="qa-review" className="scroll-mt-8">
            <QAReview recordId={deviationId} />
          </div>
        </>
      ) : null}
    </div>
